...
/*else{    
    ...
    <body style="background-image: url(img/lucem-aspicio-tile.jpg); background-size: auto">
        ...
        <div class="main">
            ...
            <h1 class="h1"><b>Registrado como: ' . $_SESSION["nombreEstudiante"] . '</b></h1>
            <div style="padding-left: 1.4%">
                <b>Id:' . $idNo . ', Correo Institucional: ' . $correoInst . '<br>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="menu">
                            ...
                            <div>
                                <a class="menu-link" href="main-estudiante.html">
